...
parser.add_argument('--epochs', default=3, help='에폭 수', type=int)
parser.add_argument('--load_path', default=None, help='모델 로드 경로', type=str)
parser.add_argument('--save_path', default="musictrans/ckpts", help='모델 저장 경로')
parser.add_argument('--data_path', default="dataset/piano", help='data path')
...
train_log_dir = 'musictrans/mt_decoder/'+current_time+'/train'
eval_log_dir = 'musictrans/mt_decoder/'+current_time+'/eval'
...
for e in range(epochs):    
    ...
    for b in range(len(dataset.files) // batch_size):
        ...
        print(b, "Loss", result_metrics[0], "Accuracy", result_metrics[1])
        if b % 100 == 0:            
