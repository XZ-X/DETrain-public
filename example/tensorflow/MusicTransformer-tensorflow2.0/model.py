...
class MusicTransformerDecoder(keras.Model):
    ...
    def __train_step(self, inp_tar, out_tar, lookup_mask, training):
        ...
        #print(hashlib.md5(str(inp_tar).encode('utf-8')).hexdigest(), hashlib.md5(str(predictions).encode('utf-8')).hexdigest(), hashlib.md5(str(self.trainable_variables).encode('utf-8')).hexdigest(), hashlib.md5(str(gradients).encode('utf-8')).hexdigest())
